...
const fa = {
  ...
  about: {
    ...
    education: { degree: "کارشناسی مهندسی برق — الکترونیک", school: "دانشکدهٔ فنی و حرفه‌ای شهید شمسی‌پور" },
    languages: [
...
const en: Content = {
  ...
  about: {
    ...
    education: { degree: "B.Sc. Electrical Engineering — Electronics", school: "Shahid Shamsipour Technical College" },
    languages: [
